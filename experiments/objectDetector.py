...
PATH_TO_LABELS = os.path.join('/home/rdelgado/Enviroments/venv/lib/python3.6/site-packages/tensorflow/models/research/object_detection/data', 'mscoco_label_map.pbtxt')
  ...
  with graph.as_default():
    with tf.Session() as sess:
      ...
      for i in range(len(images)):
        ...
        image_np = load_image_into_numpy_array(images[i])
        ...
        output_video.append(output_dict)
...
for image_path in TEST_IMAGE_PATHS:
    ...
    output_video = run_inference_for_multiple_image(input_video, detection_graph)
    ...
    with open(OUTPUT_PATH + basename + '.pkl', 'wb') as output:
        pickle.dump(output_video, output, pickle.HIGHEST_PROTOCOL)
